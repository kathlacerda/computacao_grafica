/* Arthur Menezes, Katherine Lacerda, Thais Mesquita, Rafael Jatobá, Thiago Fonseca, Gabriel Duque */
...
void cubo(){
	// Render a color-cube consisting of 6 quads with different colors
  	glLoadIdentity();  
   	glTranslatef(-4.5f, 3.0f, -6.0f);  
   	glRotatef(angleCube, cubeX, cubeY, cubeZ);  
	glBegin(GL_QUADS);                
